...
def crank_nicolson_dir(x_start,x_stop,t_stop,bndryA,bndryB,iniconds,D,xN,tN):
...
def crank_nicolson_dir_NOPLOT(x_start,x_stop,t_stop,D,xN,tN,bndryA,bndryB,iniconds):
